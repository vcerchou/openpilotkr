...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  gear_img_p = loadPixmap("../assets/addon/img/circle_red_letter-p.svg", {img_size+40, img_size+40});
  gear_img_r = loadPixmap("../assets/addon/img/circle_green_letter-r.svg", {img_size+40, img_size+40});
  gear_img_n = loadPixmap("../assets/addon/img/circle_blue_letter-n.svg", {img_size+40, img_size+40});
  gear_img_d = loadPixmap("../assets/addon/img/circle_green_letter-d.svg", {img_size+40, img_size+40});
}
