...
void AnnotatedCameraWidget::drawHud(QPainter &p) {
  ...
  if (true) {
    ...
    if (true) {
      ...
      QPen pen2(QBrush(QColor(34, 177, 76, 200)), 55);
      ...
      QPen pen3(QBrush(QColor(0, 255, 0, 200)), 55);
      ...
      QPen pen4(QBrush(QColor(255, 201, 14, 200)), 55);
      ...
      QPen pen5(QBrush(QColor(255, 127, 39, 200)), 55);
      pen5.setCapStyle(Qt::FlatCap);
      p.setPen(pen5);
      p.drawArc(rectangle, startAngle, spanAngle);

      startAngle = 0 * 16;
      spanAngle = int(fmax(-45, -15*(fmax(0, count-15)))) * 16;
      QPen pen6(QBrush(QColor(255, 0, 0, 200)), 55);
      pen6.setCapStyle(Qt::FlatCap);
      p.setPen(pen6);
      p.drawArc(rectangle, startAngle, spanAngle);
    }
  }
