...
from selfdrive.car.hyundai.values import HyundaiFlags, CAR, DBC, CANFD_CAR, CAMERA_SCC_CAR, CANFD_RADAR_SCC_CAR, EV_CAR, HYBRID_CAR, LEGACY_SAFETY_MODE_CAR, Buttons, LEGACY_SAFETY_MODE_CAR_ALT
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate in CANFD_CAR:
      ...
      ret.sccBus = 2 if Params().get_bool("OPKRLongAlt") else 0
    ...
    if ret.openpilotLongitudinalControl and not Params().get_bool("OPKRLongAlt"):
